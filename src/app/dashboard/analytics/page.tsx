    ...
    <div className="fade-in max-w-4xl mx-auto">
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', marginTop: '8px', fontSize: '15px' }}>
          High-level conversion metrics and staff responsiveness tracking.
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', marginBottom: '32px' }}>
        ...
        <div className="card" style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          ...
          <div>
            <p style={{ margin: 0, color: 'var(--text-secondary)', fontSize: '14px', fontWeight: 600, textTransform: 'uppercase' }}>Total Ingested Leads</p>
        ...
        <div className="card" style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          ...
          <div>
            <p style={{ margin: 0, color: 'var(--text-secondary)', fontSize: '14px', fontWeight: 600, textTransform: 'uppercase' }}>Avg Staff Response Time</p>
        ...
        <div className="card" style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          ...
          <div>
            <p style={{ margin: 0, color: 'var(--text-secondary)', fontSize: '14px', fontWeight: 600, textTransform: 'uppercase' }}>Successfully Closed Loans</p>
      ...
      <div className="card">
         <h3 style={{ fontSize: '18px', display: 'flex', alignItems: 'center', gap: '8px', borderBottom: '1px solid var(--border-color)', paddingBottom: '16px', marginBottom: '24px' }}>
           <Activity size={20} color="var(--primary-color)" /> Conversion Pipeline
         </h3>

         <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <PipelineRow label="1. New Meta Leads (Waiting)" count={metrics.WAITING} total={totalLeads} color="#F59E0B" />
            <PipelineRow label="2. In Review / Follow-Up" count={metrics.FOLLOW_UP + metrics.PROCESSING} total={totalLeads} color="#3B82F6" />
            <PipelineRow label="3. Docs Accepted & Verified" count={metrics.ACCEPTED + metrics.VERIFIED} total={totalLeads} color="#6366F1" />
            <PipelineRow label="4. Closed & Funded" count={metrics.CLOSED} total={totalLeads} color="#10B981" />
            <div style={{ marginTop: '16px', borderTop: '1px solid var(--border-color)', paddingTop: '16px' }}>
              <PipelineRow label="Rejected / Dropped" count={metrics.REJECTED} total={totalLeads} color="#EF4444" />
            </div>
         </div>
      </div>
    </div>
